...
import static frc.robot.Constants.Extend.*;

import frc.robot.util.BooleanChecker;

public class ExtendSubsystem extends SubsystemBase {
  private CANSparkMax m_motor = new CANSparkMax(MOTOR_ID, MotorType.kBrushless);
  ...
  public Command getRetractCommand() {
    return runOnce(() -> setSetpoint(RETRACTED_SETPOINT));
  }
  ...
  public Command getExtendCommand() {
    return runOnce(() -> setSetpoint(EXTENDED_SETPOINT));
  }
}
